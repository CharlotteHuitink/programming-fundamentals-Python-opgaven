...
# ==========================================
print(7>5 and 7<12 and not 7==10)
...
# C. print(False and True and True) = False True True, incorrect het goede antwoord is False
...
even_of_oneven_nummer = "Even" if nummer%2==0 else "Oneven"

print(even_of_oneven_nummer)
...
uur = 9
correcte_begroeting = "Goedemorgen" if uur<12 else "Goedemiddag" if uur<18 else "Goedenavond"
print(correcte_begroeting)
...
input_getal_1 = float(input("Voer eerste getal in :"))
input_getal_2 = float(input("Voer tweede getal in :"))


print(input_getal_1+input_getal_2)
print(input_getal_1*input_getal_2)

print(input_getal_1+input_getal_2, input_getal_1*input_getal_2)
print("De som van ", input_getal_1, "en ", input_getal_2, "is : ", input_getal_1+input_getal_2)
